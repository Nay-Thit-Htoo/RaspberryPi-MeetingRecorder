...
def upload_file_thread(local_file_path,record_user_obj):
    ...
    try:
        ...
        print(f"[File Upload To Server]:[File '{file_name}' uploaded successfully!]") 
        #delete_file_after_upload(local_file_path)
...
#         print(f"[File Upload To Server]:[Local File Remove] {to_remove_file_path}") 
